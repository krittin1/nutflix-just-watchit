...
public class Threatre2_15_30Controller extends Threatre1Controller {
    @FXML
    ...
    private String filename  = "BookingData2_15_30.csv";
    private int count=0;
    ...
    public void initialize() throws IOException{
        ...
        File file = new File("BookingData2_15_30.csv");
        try {
            file.createNewFile();
        } catch (IOException e) {
            e.printStackTrace();
        ...
        File file2 = new File("check2_15_30.txt");
        try {
            file2.createNewFile();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void writeCheck() throws IOException {
        Path path = Paths.get("check2_15_30.txt");
        FileWriter fileWriter = null;
        fileWriter = new FileWriter("check2_15_30.txt", true);
