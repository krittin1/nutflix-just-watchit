...
public class Threatre4_20_30Controller {
    @FXML
    ...
    private String filename  = "BookingData4_20_30.csv";
    private int count=0;
    ...
    public void initialize() throws IOException {
        ...
        File file = new File("BookingData4_20_30.csv");
        try {
            file.createNewFile();
        } catch (IOException e) {
            e.printStackTrace();
        ...
        File file2 = new File("check4_20_30.txt");
        try {
            file2.createNewFile();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void writeCheck() throws IOException {
        Path path = Paths.get("check4_20_30.txt");
        FileWriter fileWriter = null;
        fileWriter = new FileWriter("check4_20_30.txt", true);
