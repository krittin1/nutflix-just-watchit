...
public class Threatre3_15_00Controller {
    @FXML
    ...
    private String filename  = "BookingData3_15_00.csv";
    private int count=0;
    ...
    public void initialize() throws IOException {
        ...
        File file = new File("BookingData3_15_00.csv");
        try {
            file.createNewFile();
        } catch (IOException e) {
            e.printStackTrace();
        ...
        File file2 = new File("check3_15_00.txt");
        try {
            file2.createNewFile();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void writeCheck() throws IOException {
        Path path = Paths.get("check3_15_00.txt");
        FileWriter fileWriter = null;
        fileWriter = new FileWriter("check3_15_00.txt", true);
