...
public class Threatre2Controller extends Threatre1Controller {
    ...
    private String filename  = "BookingData2.csv";
    private int count=0;
    ...
    public void initialize() throws IOException{
        ...
        File file = new File("BookingData2.csv");
        try {
            file.createNewFile();
        } catch (IOException e) {
            e.printStackTrace();
        ...
        File file2 = new File("check2.txt");
        try {
            file2.createNewFile();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void writeCheck() throws IOException {
        Path path = Paths.get("check2.txt");
        FileWriter fileWriter = null;
        fileWriter = new FileWriter("check2.txt", true);
