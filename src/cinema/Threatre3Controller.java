...
public class Threatre3Controller {
    @FXML
    ...
    private String filename  = "BookingData3.csv";
    private int count=0;
    ...
    public void initialize() throws IOException {
        ...
        File file = new File("BookingData3.csv");
        try {
            file.createNewFile();
        } catch (IOException e) {
            e.printStackTrace();
        ...
        File file2 = new File("check3.txt");
        try {
            file2.createNewFile();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void writeCheck() throws IOException {
        Path path = Paths.get("check3.txt");
        FileWriter fileWriter = null;
        fileWriter = new FileWriter("check3.txt", true);
